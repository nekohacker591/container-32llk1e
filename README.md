...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-32llk1e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-32llk1e.containers.anotherwebservice.com/
...
```
git clone git@github.com:nekohacker591/container-32llk1e.git
cd container-32llk1e
```
...
```
docker attach container-32llk1e
```
